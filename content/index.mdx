...
Любые плагины, которые используют инструментарий ZwyLib сначала должны ее импортировать (предварительно ее нужно установить):
...
class MyPlugin(BasePlugin):
    pass  # тут логика вашего плагина
```
